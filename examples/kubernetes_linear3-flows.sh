ovs-ofctl add-flow -O OpenFlow13 s1 in_port=1,dl_vlan=100,actions=push_vlan:0x88a8,mod_vlan_vid:4000,output:2
...
ovs-ofctl add-flow -O OpenFlow13 s3 in_port=1,dl_vlan=100,actions=push_vlan:0x88a8,mod_vlan_vid:4000,output:2
