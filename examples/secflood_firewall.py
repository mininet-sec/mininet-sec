...
class NetworkTopo( Topo ):
    ...
    def build(self):
        ...
        #adding the secflood host, which will have use the IP address of the s99 switch
        #as its default gateway
        secflood1 = self.addHost('secflood1', ip="172.31.99.100/24", defaultRoute="via 172.31.99.1/24", publish=["8443:443"], cls=K8sPod, image="hackinsdn/secflood:latest", env=[{"name": "SECFLOOD_INTF_INSIDE", "value": "secflood1-eth0"}, {"name": "SECFLOOD_GW_INSIDE", "value": "172.31.99.1"}, {"name": "SECFLOOD_INTF_OUTSIDE", "value": "secflood1-eth1"}])
        ...
        self.addLink(s1, h2)
        self.addLink(s1, h3)
        #adding the link between the secflood and the switch s99
        #which will allow the connection with the other devices in the topology.
        self.addLink(s99, secflood1)
        self.addLink(h3, lo1)
